...
export const nl: TranslationMap = {
  ...
  sessionsView: {
    ...
    noActiveSessions: "Geen actieve gesprekken.",
  ...
  chat: {
    ...
    observer: {
      ...
      boardTimeline: "Statusgeschiedenis",
      boardCurrentRun: "Huidige uitvoering",
      boardPreviousRun: "Vorige uitvoering",
      boardUnknownRun: "Onbekende uitvoering",
      boardSinceYouLeft: "Sinds je vertrek",
      health: {
        "on-track": "Op schema",
        grinding: "Bezig",
        stuck: "Vastgelopen",
